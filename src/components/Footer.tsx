          ...
          <div className="md:col-span-1">
            <div className="flex flex-col">
              ...
              <div className="flex space-x-4">
                <a href="#" className="text-gray-400 hover:text-agency-orange transition-colors">
          ...
          {/* <div className="md:col-span-1">
            ...
            <div className="flex">
              <input 
                ...
                className="bg-gray-50 rounded-l-full px-4 py-3 outline-none flex-1 text-sm border-y border-l border-gray-300 text-gray-700"
              />
              <Button 
                size="sm" 
                className="bg-agency-orange hover:bg-agency-orange/90 text-white rounded-r-full rounded-l-none h-auto"
              >
                <Mail size={16} />
              </Button>
            </div>
